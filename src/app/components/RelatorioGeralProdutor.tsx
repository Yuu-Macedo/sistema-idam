...
export default function RelatorioGeralProdutor() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-emerald-600 bg-gradient-to-r from-emerald-600 to-emerald-700 p-6 shadow-lg">
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={gerarPDF}
                    className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-emerald-600 to-emerald-700 px-5 py-2 text-sm font-semibold text-white shadow transition hover:from-emerald-700 hover:to-emerald-800"
                  >
              ...
              {documentosDoProdutor.length === 0 ? (
                ...
                <div className="space-y-3">
                  {documentosDoProdutor.map((doc, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between rounded-lg border border-purple-200 bg-gradient-to-r from-purple-50 to-purple-100/30 p-4 transition hover:shadow-md"
                    >
  ...
  return (
    ...
    >
      <button
        ...
        className={`flex w-full items-center justify-between bg-gradient-to-r p-4 text-left text-white ${cores[cor]}`}
      >
