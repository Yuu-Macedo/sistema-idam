...
function SidebarMenuSkeleton({
  ...
  const computedIndex = Number(id.replace(/\D/g, ""));
  const widthClass =
    widthOptions[
      Number.isFinite(computedIndex)
        ? computedIndex % widthOptions.length
        : 0
    ];
  ...
  return (
    ...
    >
      ...
      <Skeleton
        className={cn(
          "h-4 flex-1 sidebar-menu-skeleton-text",
          widthClass,
        )}
